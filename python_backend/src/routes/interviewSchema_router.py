...
async def generate_interview_schemas(
    ...
    return await InterviewSchemaPipeline(no_of_interviews=no_of_interviews, updated=updated, fields=fields, companiesName=companiesName, start_date=start_date).initiate()
